...
public class Util {
    ...
    public static Boolean isMyFriend(FirebaseUser firebaseUser) {
        if(firebaseUser.getEmail().equalsIgnoreCase("jananisrishti@gmail.com")
                || firebaseUser.getEmail().equalsIgnoreCase("balaji.jeya@gmail.com")
                || firebaseUser.getEmail().equalsIgnoreCase("goyyalea@gmail.com")
                || firebaseUser.getEmail().equalsIgnoreCase("janani.srishti@gmail.com")) {
            return true;
        }
        return false;
    }

    public static void wishMyFriend(Context context, NotificationManager notificationManager) {
        CharSequence from = "JB";
        CharSequence message = "Happy Birthday Alukku Ponnu";
    ...
    public static String setChannel(NotificationManager notificationManager) {
